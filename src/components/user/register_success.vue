...
<div>
  <div id="header">
				...
				<div>
					<span v-if="loginStatus">welcome <span class="um_span">{{username}}</span>welcome to atguigu book sotre</span>
		...
		<div id="main">
			...
			<h1>register success <router-link to="/">返回首页</router-link></h1>
